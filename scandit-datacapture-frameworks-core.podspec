Pod::Spec.new do |s|
    ...
    s.source                  = { :git => 'https://github.com/Scandit/scandit-datacapture-frameworks-core.git', :tag => '6.19.0-beta.2' }
    s.swift_version           = '5.7'
    ...
    s.dependency 'ScanditCaptureCore', '= 6.19.0-beta.2'
end
